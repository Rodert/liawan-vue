...
values (100, 0, '0', '俩万科技', 0, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳总公司', 1, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '俩万', '15888888888', 'liawan@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
values (1, 103, 'admin', '倆萬', '00', 'liawan@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, 'liawan', '俩万', '00', 'liawan@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
values ('3', '系统工具', '0', '3', 'tool', null, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), '', null,
        '系统工具目录');
insert into sys_menu
values ('4', '俩万官网', '0', '4', 'http://javapub.net.cn', null, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', sysdate(),
        '', null, '俩万官网地址');
INSERT INTO sys_menu
VALUES ('5', '请假审批', '0', '3', '/', NULL, NULL, 1, 0, 'M', '0', '0', '', 'example', 'admin', sysdate(), '', null, '');
...
INSERT INTO `sys_menu`
VALUES ('117', '请假申请', '5', '0', '', 'leaveapply/index', '', 1, 0, 'C', '0', '0', 'system:apply:list', 'checkbox',
        'admin', sysdate(),
        '', null,
        '请假申请菜单');
# INSERT INTO `sys_menu`
# VALUES ('118', '我的待办', '5', '0', '', 'leaveapply/index', '', 1, 0, 'C', '0', '0', 'system:apply:list', 'checkbox',
#         'admin', sysdate(),
#         '', null,
#         '我的待办菜单');
INSERT INTO `sys_menu`
VALUES ('119', '全部待办', '5', '0', 'alltask', 'leaveapply/task', '', 1, 0, 'C', '0', '0', 'system:apply:list', 'checkbox',
        'admin', sysdate(),
        '', null,
        '全部待办菜单');
# INSERT INTO `sys_menu`
...
-- 请假审批按钮
insert into sys_menu
values ('1061', '请假查询', '117', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:apply:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1062', '请假新增', '117', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:apply:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1063', '请假修改', '117', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:apply:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1064', '请假删除', '117', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:apply:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1065', '请假导出', '117', '5', '#', '', '', 1, 0, 'F', '0', '0', 'system:apply:export', '#', 'admin', sysdate(),
        '', null, '');
...
insert into sys_job
values (1, '系统默认（无参）', 'DEFAULT', 'lwTask.lwNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null,
        '');
insert into sys_job
values (2, '系统默认（有参）', 'DEFAULT', 'lwTask.lwParams(\'lw\')', '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '',
        null, '');
insert into sys_job
values (3, '系统默认（多参）', 'DEFAULT', 'lwTask.lwMultipleParams(\'lw\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3',
...
values ('1', '温馨提醒：2022-05-15 俩万新版本发布啦，由公众号JavaPub维护持续更新', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice
values ('2', '维护通知：2022-05-15 俩万系统凌晨维护，由公众号JavaPub维护持续更新', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT ='请假表'
  ROW_FORMAT = Dynamic;
...
VALUES (52, 'admin', '2022-05-04 10:30:59', '2022-05-17 09:10:59', '事假', 'asd', '2022-05-12 16:17:09',
        '2022-05-03 09:25:19', '2022-05-12 16:35:19', '', NULL, '', NULL);
INSERT INTO `leave_apply`
VALUES (53, 'admin', '2022-05-04 06:10:29', '2022-05-11 06:30:29', '事假', 'gfg', '2022-05-12 16:17:41', NULL, NULL, '',
        NULL, '', NULL);
INSERT INTO `leave_apply`
VALUES (54, 'admin', '2022-05-05 06:30:27', '2022-05-12 10:50:27', '事假', 'fsd', '2022-05-12 16:51:36', NULL, NULL, '',
        NULL, '', NULL);
INSERT INTO `leave_apply`
VALUES (55, 'admin', '2022-05-11 05:25:55', '2022-05-17 09:30:55', '事假', 'dd', '2022-05-16 19:10:04',
        '2022-05-03 06:10:39', '2022-05-19 19:30:39', '', NULL, '', NULL);
